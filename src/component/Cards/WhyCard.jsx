const WhyCard = ({ title, subtitle }) => {
    return (
      <div className="relative container mx-auto">
        ...
        {/* Card */}
        <div className="h-[320px] md:w-[250px] w-[300px] border-2 border-red-600 rounded-md transition-all duration-300 hover:shadow-lg hover:border-red-300 hover:scale-105 ">
